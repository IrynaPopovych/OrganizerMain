...
/**
 * Created by irkap on 08.11.2016.
 */
...
public class EventEditView extends RelativeLayout {
    ...
    private com.example.bohdan.myorganizermain.EventEditView.Event mEvent = com.example.bohdan.myorganizermain.EventEditView.Event.createInstance();
     ...
     */
    public void setEvent(@NonNull com.example.bohdan.myorganizermain.EventEditView.Event event) {
        mEvent = event;
     ...
     */
    @NonNull
    public com.example.bohdan.myorganizermain.EventEditView.Event getEvent() {
        return mEvent;
    }
    ...
    private void setCalendarId(long calendarId) {
        ...
        if (calendarId == com.example.bohdan.myorganizermain.EventEditView.Event.NO_ID) {
    ...
    /**
     * View model for {@link com.example.bohdan.myorganizermain.EventEditView}.
     * Event represented by this class is assumed to be in system timezone.
     */
    public static class Event implements Parcelable {

        public static final Creator<com.example.bohdan.myorganizermain.EventEditView.Event> CREATOR = new Creator<Event>() {
            @Override
            public Event createFromParcel(Parcel in) {
                return new com.example.bohdan.myorganizermain.EventEditView.Event(in);
            }

            @Override
            public Event[] newArray(int size) {
                return new com.example.bohdan.myorganizermain.EventEditView.Event[size];
            }
        };

        /**
         * Creates an instance of {@link com.example.bohdan.myorganizermain.EventEditView.Event} that starts at 'earliest' future time
         * @return  an {@link com.example.bohdan.myorganizermain.EventEditView.Event} instance
         */
        public static com.example.bohdan.myorganizermain.EventEditView.Event createInstance() {
            return new com.example.bohdan.myorganizermain.EventEditView.Event();
        }

        /**
         * Builder utility to build an {@link com.example.bohdan.myorganizermain.EventEditView.Event}
         */
        public static class Builder {
            private final com.example.bohdan.myorganizermain.EventEditView.Event event = new com.example.bohdan.myorganizermain.EventEditView.Event();
             ...
             */
            public com.example.bohdan.myorganizermain.EventEditView.Event.Builder id(long id) {
                event.id = id;
                return this;
            }
             ...
             * @return  this instance (fluent API)
             */
            public com.example.bohdan.myorganizermain.EventEditView.Event.Builder calendarId(long calendarId) {
             ...
             * @return  this instance (fluent API)
             */
            public com.example.bohdan.myorganizermain.EventEditView.Event.Builder title(String title) {
                event.title = title;
                return this;
            }
             ...
             * @return  this instance (fluent API)
             */
            public com.example.bohdan.myorganizermain.EventEditView.Event.Builder start(long timeMillis) {
             ...
             * @return  this instance (fluent API)
             */
            public com.example.bohdan.myorganizermain.EventEditView.Event.Builder end(long timeMillis) {
             ...
             * @return  this instance (fluent API)
             */
            public com.example.bohdan.myorganizermain.EventEditView.Event.Builder allDay(boolean isAllDay) {
                event.isAllDay = isAllDay;
                return this;
            }

            /**
             * Creates the {@link com.example.bohdan.myorganizermain.EventEditView.Event} that has been built by this builder
             * @return  an {@link com.example.bohdan.myorganizermain.EventEditView.Event} instance
             */
            public com.example.bohdan.myorganizermain.EventEditView.Event build() {
                return event;
            }
        }
